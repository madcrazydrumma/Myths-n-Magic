...
public class OlympusPortal extends BlockBreakable
{
	public OlympusPortal(int par1) {
		super(par1, "mnm:olympusPortal", Material.portal, false);
	...
	public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
		...
		if (b0 == b1) {
			...
			for (l = 0; l < 2; ++l) {
				for (i1 = 0; i1 < 3; ++i1) {
					par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, MNMBlocks.olympusPortal.blockID, 0, 2);
				}
			}
			return true;
		}
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
		if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP))) {
			...
			} else if (thePlayer.dimension != Util.olympusID) {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Util.olympusID, new OlympusTeleporter(thePlayer.mcServer.worldServerForDimension(Util.olympusID)));
			} else {
				thePlayer.timeUntilPortal = 10;
				thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new OlympusTeleporter(thePlayer.mcServer.worldServerForDimension(0)));
			}
		}
	}
