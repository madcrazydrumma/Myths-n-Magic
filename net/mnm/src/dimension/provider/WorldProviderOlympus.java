package net.mnm.src.dimension.provider;
...
public class WorldProviderOlympus extends WorldProvider
{
	...
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerHell(BiomeGenBase.forest, this.dimensionId, this.dimensionId);
		this.dimensionId = Util.olympusID;
		this.hasNoSky = false;
	}
	...
	public String getWelcomeMessage() {
		if ((this instanceof WorldProviderOlympus)) {
			return "Welcome to Olympus";
		}
		return null;
	}
