...
import net.mnm.src.world.genlayer.GenLayerMnM;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class WorldChunkManagerOlympus extends WorldChunkManager
{
	...
	protected WorldChunkManagerOlympus()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(MNMBiomes.olympusBiome);
	}

	public WorldChunkManagerOlympus(long seed, WorldType worldtype)
	{
		this();
		GenLayer[] agenlayer = GenLayerMnM.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerOlympus(World world)
	{
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = MNMBiomes.olympusBiome;
			}
		}
